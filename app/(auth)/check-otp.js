...
export default function App() {
  ...
  const clickHandler = async () => {
    try {
      ...
      // API call
      setIsLoading(true);
      const link = type === 'student' ? `${process.env.EXPO_PUBLIC_API_URL}/students/student/check-otp` : `${process.env.EXPO_PUBLIC_API_URL}/teachers/teacher/check-otp`;
      ...
      setVisible(true);
      setIsLoading(false);
      router.push({pathname:'/register', params:{type}});
